	...
	<div class="col-md-5 d-flex align-items-stretch grid-margin">
		<div class="row flex-grow">
			<div class="col-12">
				...
				<?php } ?>
				<?php echo form_open('admin/level/save_level')?>
				<?php $id = (isset($status->id)) ? $status->id : '-1' ; ?>
				<input type="hidden" name="id" value="<?=$id?>">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Form Bagian/Unit/Level</h4>
							...
							<?php echo form_close()?>
							<?php if ($id != -1) {?>
								<a href="<?=base_url('admin/level/destroy_level/'.$id)?>" class="btn btn-danger mr-2">Delete</a>
							<?php } ?>
							<a href="<?=base_url('admin/level')?>" class="btn btn-primary mr-2">Back To List</a>
